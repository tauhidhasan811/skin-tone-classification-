...
app = FastAPI(title="ViT Skin Tone Model API")


@app.get("/")
def home():
    return {"message": "✅ Skin Tone Model API is running! Use POST /predict to get predictions."}
...
async def predict(file: UploadFile = File(...)):
    try:
        ...
        transform = processor.image_processor if hasattr(processor, "image_processor") else processor
        ...
        return JSONResponse(content={
            ...
            'Name : ': skin_tones[predicted_class],
